...
# Buff coletável de tiro triplo
TRIPLE_SHOT_PICKUP_TTL = 10.0
TRIPLE_SHOT_PICKUP_RADIUS = 12
TRIPLE_SHOT_ANGLE_OFFSET = 15.0
TRIPLE_SHOT_SPAWN_CHANCE = 0.15
TRIPLE_SHOT_COLOR = (255, 215, 0)
TRIPLE_SHOT_DURATION = 7.0
...
SPECIAL_AST_CHANCE = 0.25

POWERUP_RADIUS = 8
POWERUP_TTL = 9.0
POWERUP_BLINK_HZ = 3.0
POWERUP_BLINK_THRESHOLD = 3.0
